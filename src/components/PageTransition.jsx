...
const PageTransition = ({ children, mode = 'fade' }) => {
    ...
    const [isLoading, setIsLoading] = React.useState(false); // Disabled loading for debugging
    const [loadProgress, setLoadProgress] = React.useState(0);
    const [showContent, setShowContent] = React.useState(true); // Always show content for debugging

    // Temporarily disabled loading screen for debugging
    React.useEffect(() => {
        console.log('🔄 PAGE LOADED:', location.pathname);
        // Loading disabled for debugging
